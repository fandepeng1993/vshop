<template>
  <div class="date-picker">
    <div class="input-wrapper" v-if="false" @mouseenter="showCancel = true" @mouseleave="showCancel = false">
      <div class="input" @click="togglePanel" v-text="range ? value[0] + ' -- ' + value[1] : value"></div>
        <img class="cancel-btn" src="" v-show="showCancel" @click="clear">
    </div>
      <div class="date-panel" v-show="true" :style="coordinates">
      ...
      selectDate(date) {
        setTimeout(() => {
          ...
          if (!this.range) {
            ...
            this.$emit('getselectdate', 1,value)
